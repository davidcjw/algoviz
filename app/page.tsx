            ...
            <div>
              ...
              <Reveal i={3}>
                <div className="mt-9 flex flex-col gap-2.5 sm:flex-row sm:flex-wrap sm:items-center">
                  <Link
                    href="/learn"
                    className="group inline-flex w-full items-center justify-center gap-2 rounded-lg bg-brand px-4 py-2.5 text-sm font-semibold text-white transition-transform hover:scale-[1.03] active:scale-95 sm:w-auto sm:justify-start"
                  >
                    Start exploring
                    <ArrowRight
                      size={16}
                  ...
                  <Link
                    ...
                    className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-line bg-white/5 px-4 py-2.5 text-sm font-semibold text-coal backdrop-blur transition-colors hover:bg-white/10 sm:w-auto sm:justify-start"
                  >
                    <MousePointerClick size={16} className="text-ds" />
                    Try a visualizer
                  </Link>
                  <a
                    href={GITHUB_URL}
                    ...
                    className="group inline-flex w-full items-center justify-center gap-2 rounded-lg border border-line bg-white/5 px-4 py-2.5 text-sm font-semibold text-coal backdrop-blur transition-colors hover:bg-white/10 sm:w-auto sm:justify-start"
                  >
                    <Github size={16} />
                    Star
                    <Star
